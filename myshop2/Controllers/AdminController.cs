...
namespace myshop2.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            // Remove the admin session key instead of calling Equals which does nothing
        ...
        public IActionResult ChangeProfileImage(IFormFile admin_image, Admin admin)
        {
            if (admin_image != null)
            {
                ...
                // Ensure the stream is disposed properly
        ...
        [HttpPost]
        public IActionResult updateCustomer(IFormFile customer_image, Customer customer)
        {
